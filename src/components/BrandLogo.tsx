    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-2">
          <span
            className={`font-serif tracking-wider font-bold text-stone-900 dark:text-stone-100 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors ${titleSize}`}
          >
        ...
        {showSubtitle && (
          <div className="flex items-center gap-1.5 mt-0.5">
            <span
              className={`font-mono uppercase tracking-[0.2em] font-semibold text-amber-700 dark:text-amber-400 ${subtitleSize}`}
            >
